...
export default function Header() {
  ...
  return (
    <header className="w-full">
      <div className="bg-brand-gray-dark min-h-8 flex items-center justify-center md:justify-end px-4 md:px-20">
       <p className="text-white text-xs md:text-[13px] whitespace-nowrap overflow-visible tracking-normal md:tracking-[1.8px] flex items-center h-full pt-6">
